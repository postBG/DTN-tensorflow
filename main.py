...
flags.DEFINE_integer("input_size", 32,
                     "THe size of input images [32]")  # assume square. We need it because we will use other dataset
flags.DEFINE_integer("output_size", 32,
                     "THe size of output images [32]")  # assume square. We need it because we will use other dataset
